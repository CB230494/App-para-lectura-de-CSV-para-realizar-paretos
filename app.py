# =========================================================
# DOCUMENTADO — PARTE 1 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Encabezado del archivo
# 2) Importaciones
# 3) Configuración inicial de Streamlit
# 4) Constantes generales de configuración
# 5) Diccionarios y conjuntos base para reglas de conteo
# 6) Refuerzos directos para preguntas unificadas
# 7) Inicio de utilidades de texto
# 8) Detección del tipo de archivo
# ---------------------------------------------------------
# IMPORTANTE:
# - Esta parte está copiada respetando el contenido original.
# - No se ha cambiado lógica, signos, comas ni estructura.
# - Debe pegarse exactamente al inicio del archivo app.py
# =========================================================
...
def infer_file_type(filename: str) -> str:
    ...
    return ""
   # =========================================================
# DOCUMENTADO — PARTE 2 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Carga y lectura del Excel guía
# 2) Construcción del resumen del Excel guía
# 3) Lectura robusta de archivos CSV
# 4) Normalización de encabezados del CSV
# ---------------------------------------------------------
# IMPORTANTE:
# - Esta parte continúa exactamente después de la Parte 1.
# - No se ha cambiado lógica, signos, comas ni estructura.
# - Debe pegarse inmediatamente después de la Parte 1
# =========================================================
...
def flatten_headers(df: pd.DataFrame) -> pd.DataFrame:
    ...
    return df
    # =========================================================
# DOCUMENTADO — PARTE 3 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Utilidades para ubicar preguntas dentro del CSV
# 2) Lógica de puntuación para encontrar la mejor columna
# 3) Funciones para dividir y limpiar respuestas multiselección
# 4) Regla especial para comunidad pregunta 27
# 5) Filtros de opciones no productivas
# ---------------------------------------------------------
# IMPORTANTE:
# - Esta parte continúa exactamente después de la Parte 2.
# - No se ha cambiado lógica, signos, comas ni estructura.
# - Debe pegarse inmediatamente después de la Parte 2
# =========================================================
...
def tokenize_cell_unique(value: str, file_type: str = "", question_num: str = ""):
    ...
    # =========================================================
# DOCUMENTADO — PARTE 4 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Reglas de conteo (exacto vs unificado)
# 2) Construcción de etiquetas unificadas
# 3) Inicio de alias de descriptores
# ---------------------------------------------------------
# IMPORTANTE:
# - Continúa exactamente después de la Parte 3
# - No se modifica nada del código original
# =========================================================
...
def build_descriptor_aliases(file_type: str, question_num: str, descriptor_text: str):
    ...
    alias_map = {
        ...
        # =========================================================
# DOCUMENTADO — PARTE 5 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Continuación del alias_map (normalización fuerte)
# 2) Reglas de agrupación específicas (oferta, infraestructura, etc.)
# 3) Alias para préstamos gota a gota
# 4) Alias específicos para delitos ambientales (pregunta 27)
# ---------------------------------------------------------
# IMPORTANTE:
# - Continúa exactamente después de la Parte 4
# - No se modifica nada del código original
# =========================================================
    ...
    if base_norm in alias_map:
        ...
        # =========================================================
# DOCUMENTADO — PARTE 6 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Continuación de build_descriptor_aliases()
# 2) Reglas adicionales dinámicas por tipo y pregunta
# 3) Normalización final de alias
# 4) Construcción de grupos exactos (agrupación inteligente)
# ---------------------------------------------------------
# IMPORTANTE:
# - Continúa exactamente después de la Parte 5
# - No se modifica nada del código original
# =========================================================
...
def get_exact_canonical_group(file_type: str, question_num: str, descriptor_text: str):
    ...
    # Comunidad 27: unificación ambiental
    ...
    # =========================================================
# DOCUMENTADO — PARTE 7 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Construcción de grupos por pregunta
# 2) Conteo exacto
# 3) Conteo unificado
# 4) Búsqueda de tokens no ubicados
# 5) Regla especial de cruce: Comercio 18 -> Comercio 12
# ---------------------------------------------------------
# IMPORTANTE:
# - Continúa exactamente después de la Parte 6
# - No se modifica nada del código original
# =========================================================
...
def apply_special_cross_question_rules(df_results: pd.DataFrame) -> pd.DataFrame:
    ...
    return df_results
    # =========================================================
# DOCUMENTADO — PARTE 8 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Inicio del procesamiento principal por archivo
# 2) Construcción de resultados por pregunta
# 3) Refuerzos dinámicos por tipo y pregunta
# 4) Preparación de mapeos y opciones no ubicadas
# ---------------------------------------------------------
# IMPORTANTE:
# - Continúa exactamente después de la Parte 7
# - No se modifica nada del código original
# =========================================================
    ...
    for (preg_num, preg_text), items in grouped_questions.items():
        ...
        if file_type == "comercio" and preg_num == "15":
            ...
            for _, group_info in group_defs.items():
                ...
                # =========================================================
# DOCUMENTADO — PARTE 9 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Continuación del procesamiento principal por archivo
# 2) Refuerzos dinámicos para policial, comunidad 27 y estafa
# 3) Conteo final por grupo
# 4) Construcción de dataframes de salida
# 5) Resúmenes y utilidades de exportación
# ---------------------------------------------------------
# IMPORTANTE:
# - Continúa exactamente después de la Parte 8
# - No se modifica nada del código original
# =========================================================
...
def to_excel_bytes(dfs: dict) -> bytes:
    ...
    # =========================================================
# DOCUMENTADO — PARTE 10 DE 10
# ---------------------------------------------------------
# Esta parte contiene:
# 1) Renderizado de tablas en pantalla
# 2) Interfaz principal de Streamlit
# 3) Carga de archivos CSV
# 4) Aplicación de filtros
# 5) Métricas generales
# 6) Tabs de resultados
# 7) Exportación final a Excel
# ---------------------------------------------------------
# IMPORTANTE:
# - Continúa exactamente después de la Parte 9
# - No se modifica nada del código original
# =========================================================
